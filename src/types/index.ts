...
export interface Memory { id: string; date: string; title: string; description?: string; image?: string; imagePath?: string; location?: string; favorite: boolean; public: boolean; createdAt?: string }
